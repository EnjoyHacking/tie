/*
 *  src/host/host_output.h - Component of the TIE v1.0.0-beta3 platform 
 *
...
#ifndef H_HOST_OUTPUT
#define H_HOST_OUTPUT
...
int ht_dump_report(FILE *);
int ht_dump_host_data(struct ht_entry **, char *);
